...
> 이클립스 sts 버전에서 File - New - Spring Legacy Project, Spring MVC Project 생성

![img](md-images/img.png)



![img](md-images/img-16415411014952.png)



![img](md-images/img-16415411468924.png)
...
> DataSource 및 Mybatis, Mybatis Log 설정
...
> src/main/resources 디렉토리 생성 후 mybatis-config.xml 파일 생성

![img](md-images/img-16415416351816.png)
...
> src/main/resources 디렉토리 내 log4jdbc.log4j2.properties파일, logback.xml 파일 생성
...
### 2-6. articleMapper.xml

> mappers/article 디렉토리 내 게시판 쿼리문 xml 파일 생성
...
> 기본패키지.VO 패키지 내 mapper 맵핑을 위한 VO.java 생성
